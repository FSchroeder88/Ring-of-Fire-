...
export class PlayerInfoComponent implements OnInit, OnChanges {
  ...
  cardAction = [
    ...
    { title: 'Quizmaster', description: 'Touch the floor with your hand. The teammate who was last on the ground has to take a sip.' },
  ...
  ngOnChanges(): void {
    if (this.card) {
      ...
      let cardNumber = +this.card.split(/([0-9]+)/)[1];
